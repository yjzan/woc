...
jQuery( function( $ ) {
    ...
    var wc_checkout_form = {
        ...
        init: function() {
            ...
            this.$checkout_form.on( 'change', '#billing_state, #billing_country', this.input_changed );
        ...
        update_checkout_action: function( args ) {
            ...
            var data = {
                ...
                ysshid       :  $('#ysshid').length >0 ? $( '#ysshid' ).val():''
            };
        ...
        submit: function() {
            ...
            if ( $form.triggerHandler( 'checkout_place_order' ) !== false && $form.triggerHandler( 'checkout_place_order_' + wc_checkout_form.get_payment_method() ) !== false ) {
                ...
                if($('#ysshid').length >0  && $('#ysshid').val()!='')
                {
                    data_form +='&ysshid='+$('#ysshid').val();
                }
                $.ajax({
                    type:		'POST',
