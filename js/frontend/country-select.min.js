...
jQuery( function( $ ) {
    ...
    function init_city_area()
    {
        ...
        var state = $('#billing_state').data("statesvalue");
        var city =  $('#billing_city').data("cityvalue");
        var area = $('#billing_area').data("areavalue");
        ...
        {
            $("#billing_state option:contains("+state+")").attr("selected", true);
        }

        var city_data =[];
        for(var i=0;i<city_json_data.length;i++)
        {
            if(city_json_data[i].name == state || city_json_data[i].name == state_array[state])
            {
