        ...
        init: function() {
            $( '#woocommerce-order-notes' )
                ...
                .on( 'click', 'span.express_no', function(){
                    ...
                    if($("#express_iframe").attr("src")!="http://www.kdniao.com/JSInvoke/MSearchTrackDetail.aspx?ExpNo="+$(this).data('expressno'))
                    {
                        console.log(1);
                        $("#express_iframe").attr("src", "http://www.kdniao.com/JSInvoke/MSearchTrackDetail.aspx?ExpNo="+$(this).data('expressno'));
                    }else
                    {
                        console.log(0);
                    }
